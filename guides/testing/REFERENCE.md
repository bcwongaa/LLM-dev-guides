...
Binding surface: [`RULES.md`](RULES.md). This file keeps the original testing prose and examples.
...
- Test naming, factories, and structure (moved from [`../code-style/RULES.md`](../code-style/RULES.md))
...
|---|---|
| Day-to-day non-test code shape | [`../code-style/RULES.md`](../code-style/RULES.md) |
| Stack and test-runner choice (Jest vs …) | [`../stack/RULES.md`](../stack/RULES.md) / project tooling |
| Schema correctness beyond “test the invariant” | [`../data/RULES.md`](../data/RULES.md) |
...
- Each engine ([`../architecture/RULES.md`](../architecture/RULES.md)) should be testable without standing up the entire product.
...
This pairs with [`../architecture/RULES.md`](../architecture/RULES.md): logical engines with public surfaces are easier to test in isolation.
...
These rules used to live in [`../code-style/RULES.md`](../code-style/RULES.md) §20; **this guide owns them**.
...
Aligns with [`../protocol/RULES.md`](../protocol/RULES.md) / [`../code-style/RULES.md`](../code-style/RULES.md) “tests not worse,” and strengthens it: **not worse is necessary but not
...
(same spirit as [`../architecture/RULES.md`](../architecture/RULES.md): prefer duplication until pain is real).
...
| Topic | Layer |
|---|---|
| Protocol / done bar / scope | [`../protocol/RULES.md`](../protocol/RULES.md) |
| Non-test code shape (code-style §20 now points here) | [`../code-style/RULES.md`](../code-style/RULES.md) |
| Engines/modules testable in isolation | [`../architecture/RULES.md`](../architecture/RULES.md) |
| Runner/tooling defaults | [`../stack/RULES.md`](../stack/RULES.md) / project |
| Data invariants under test | [`../data/RULES.md`](../data/RULES.md) |
| Contract tests at the wire | [`../contracts/RULES.md`](../contracts/RULES.md) |
| Authz / IDOR regressions | **security** |
| Safe rollout of test impact | **release** |

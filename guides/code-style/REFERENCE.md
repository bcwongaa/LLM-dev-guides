...
This file preserves the original v1 coding-style rationale, examples, trade-offs,
and exceptions. Binding rules live in [`RULES.md`](RULES.md). If the two disagree,
`RULES.md` is the compact surface; this file is the source of author voice and
should be used to restore meaning during review — not as a second law to invent
from.

Former path: `L1_CODING_STYLE.md` (v1). Numbered sections below keep the v1
numbering so conservation review can compare heading-for-heading.
...
**architecture** (`../architecture/RULES.md`) and related guides. Style here is about the smell and
...
## 16. Caching: stale-while-revalidate — moved

Normative home: [`guides/architecture/RULES.md`](../architecture/RULES.md).
Original wording and any examples: [`guides/architecture/REFERENCE.md`](../architecture/REFERENCE.md).

Do not keep a second copy of the cache procedure here.

## 17. Polling for async job results — moved

Normative home: [`guides/architecture/RULES.md`](../architecture/RULES.md).
Original wording and the bounded-loop example: [`guides/architecture/REFERENCE.md`](../architecture/REFERENCE.md).

## 18. Async job dispatch via central mapping — moved

Normative home: [`guides/architecture/RULES.md`](../architecture/RULES.md).
Original wording: [`guides/architecture/REFERENCE.md`](../architecture/REFERENCE.md).

## 19. Two tiers of data access — moved

Normative home: [`guides/data/RULES.md`](../data/RULES.md).
Original wording: [`guides/data/REFERENCE.md`](../data/REFERENCE.md).

## 20. Tests → testing

Testing policy, TDD, pyramid, mocks, flakes, naming, and factories live in
**testing** (`../testing/RULES.md`); this section is only a pointer. Do not invent a second test style here.

Day-to-day reminder only: tests must **not be worse** after a change (see “What complete
means” and post-code check above). For everything else about tests, open testing.

---

## 21. Log format — moved

Normative home: [`guides/observability/RULES.md`](../observability/RULES.md).
Original wording: [`guides/observability/REFERENCE.md`](../observability/REFERENCE.md).
Observability *policy* (levels, request ids, metrics, traces, health) remains `../observability/RULES.md`.
...
**protocol → Local convention**. Short form: net-new files follow code-style; edits inside an existing

...
Binding surface: [`RULES.md`](RULES.md). This file keeps the original data-model prose and the relocated two-tier access section.
...
- language, framework, or storage selection — [`../stack/RULES.md`](../stack/RULES.md);
- greenfield domain boundaries and project layout — [`../architecture/RULES.md`](../architecture/RULES.md);
- HTTP, event, DTO, or wire contracts — [`../contracts/RULES.md`](../contracts/RULES.md);
- runtime data health, pipeline execution signals, or lineage — **observability**;
- deployment choreography, expand/contract rollout, or rollback — [`../release/RULES.md`](../release/RULES.md);
- authentication, PII policy, or secrets — [`../security/RULES.md`](../security/RULES.md).

[`../stack/RULES.md`](../stack/RULES.md) decides which storage role is appropriate. This guide decides how data behaves once that storage
has been chosen.
...
Code-style’s distinction remains important:
...
See [`../code-style/RULES.md`](../code-style/RULES.md).
...
Follow [`../stack/RULES.md`](../stack/RULES.md) and [`../code-style/RULES.md`](../code-style/RULES.md):
...
documents cannot be assumed valid. Use native queries as [`../stack/RULES.md`](../stack/RULES.md) requires; do not add a heavy ODM
...
retention is not a substitute for [`../security/RULES.md`](../security/RULES.md) security and PII rules.
...
The exact deployment choreography belongs to [`../release/RULES.md`](../release/RULES.md). This guide still owns the data-safety fact that
...
that belongs with [`../contracts/RULES.md`](../contracts/RULES.md) and [`../release/RULES.md`](../release/RULES.md).
...
**A direct SQL query beside ORM CRUD.** [`../code-style/RULES.md`](../code-style/RULES.md) and [`../stack/RULES.md`](../stack/RULES.md) prefer direct storage-client access when
...
- [ ] [`../code-style/RULES.md`](../code-style/RULES.md) post-code checks still apply to the code and migration work.

## Relationship to other layers

| Topic | Layer |
|---|---|
| Agent protocol and missing-guide behavior | [`../protocol/REFERENCE.md`](../protocol/REFERENCE.md) |
| Code shape, entity boundaries, null-vs-absent code style | [`../code-style/RULES.md`](../code-style/RULES.md) |
| Greenfield layout and domain boundaries | [`../architecture/RULES.md`](../architecture/RULES.md) |
| Language, framework, storage role, ORM defaults | [`../stack/RULES.md`](../stack/RULES.md) |
| Wire DTOs, HTTP/events, idempotency | [`../contracts/RULES.md`](../contracts/RULES.md) |
| Database health, runtime data health, and lineage | **observability** / `../observability/RULES.md` |
| Testing data-related behavior | **testing** / `../testing/RULES.md` |
| Expand/contract rollout, rollback, deploy safety | [`../release/RULES.md`](../release/RULES.md) |
| Auth, PII, and secrets | [`../security/RULES.md`](../security/RULES.md) |
| Standing data-store decisions | [`../decisions/`](../decisions/) |

---

## 19. Two tiers of data access

Original v1 wording relocated from `L1_CODING_STYLE.md` §19.

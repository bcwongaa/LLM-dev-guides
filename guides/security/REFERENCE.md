...
Binding surface: [`RULES.md`](RULES.md). This file keeps the original security and secrets prose and examples.
...
- Webhooks and untrusted inbound (with [contracts](../contracts/RULES.md))

**Out of scope**

| Concern | Where it lives |
|---|---|
| Wire principal placement (light) | [contracts](../contracts/RULES.md) |
| Don’t log secrets (also) | [observability](../observability/RULES.md) — this guide owns the broader secret/PII law |
| Schema-level access quirks | [data](../data/RULES.md) |
| Deploy of secret material | [`../release/RULES.md`](../release/RULES.md) (config by env; human ships prod) |
| Standing security architecture decisions | [`../decisions/`](../decisions/) |
| Full threat models, SOC2, legal retention schedules | Human / org process |
| Framework choice for auth libraries | [stack](../stack/RULES.md) + author |

If unsure whether something is security-sensitive: **ask** ([protocol](../protocol/RULES.md)).
...
6. Tests cover authz/IDOR regressions when those paths change ([`../testing/RULES.md`](../testing/RULES.md)).

---

## 1. Secrets

**Secrets never belong in git as real values**, in frontend bundles, or in logs ([observability](../observability/RULES.md)).
...
- **Do not log PII freely** ([observability](../observability/RULES.md)); prefer opaque ids in logs.
...
- Prefer the **existing stack** and known libraries ([stack](../stack/RULES.md)).
...
- Admin tools that run dangerous jobs follow [`../release/RULES.md`](../release/RULES.md) (approval, no silent data destruction).
...
Align [contracts](../contracts/RULES.md): verify signatures, treat body as untrusted, handle idempotently.  
...
Always ask (also [protocol](../protocol/RULES.md)) before:
...
- Legacy brownfield: do not expand insecure patterns; fix on touch when in scope ([protocol](../protocol/RULES.md) / [code-style](../code-style/RULES.md)).
...
- [ ] Security-sensitive tests added/updated ([`../testing/RULES.md`](../testing/RULES.md))
- [ ] Asked on [protocol](../protocol/RULES.md) security / auth model changes

## Relationship to other layers

| Topic | Layer |
|---|---|
| Always ask on security | [protocol](../protocol/RULES.md) |
| Code shape | [code-style](../code-style/RULES.md) |
| Stack / packages | [stack](../stack/RULES.md) |
| Data at rest shape | [data](../data/RULES.md) |
| Wire auth light, webhooks | [contracts](../contracts/RULES.md) |
| Telemetry redaction | [observability](../observability/RULES.md) |
| Authz/IDOR tests | [`../testing/RULES.md`](../testing/RULES.md) |
| Config by env, prod ship | [`../release/RULES.md`](../release/RULES.md) |
| ADRs for major auth choices | [`../decisions/`](../decisions/) |
